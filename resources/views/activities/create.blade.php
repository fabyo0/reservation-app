        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="overflow-hidden overflow-x-auto border-b border-gray-200 bg-white p-6">
                    <form action="{{ route('companies.activities.store', $company) }}" method="POST"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="start_time" name="start_time" value="{{ old('start_time') }}"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price" name="price" value="{{ old('price') }}" type="number" step="0.01"
                                          class="mt-1 block w-full"/>
